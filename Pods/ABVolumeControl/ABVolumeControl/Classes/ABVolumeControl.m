...
- (void) setVolumeControlStyle:(ABVolumeControlStyle)volumeControlStyle {
    ...
    if (volumeControlStyle == ABVolumeControlStyleMinimal) {
        ...
        self.volumeBackground = [[UIView alloc] initWithFrame:CGRectMake(0, 0, viewWidth, 4)];
        self.volumeBackground.backgroundColor = [self colorWithHexString:@"d4d4d4"];
        self.volumeBackground.alpha = 0;

        // Initialize volumeBar
        self.volumeBar = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 0, 4)];
        ...
        // Initialize volumeBackground
        self.volumeBackground = [[UIView alloc] initWithFrame:CGRectMake(12.0f, -9.0f, viewWidth-24.0f, 4.0f)];
        self.volumeBackground.backgroundColor = [self colorWithHexString:@"d4d4d4"];
        self.volumeBackground.alpha = 1.0f;

        // Initialize volumeBar
        self.volumeBar = [[UIView alloc] initWithFrame:CGRectMake(12.0f, -9.0f, viewWidth-24.0f, 4.0f)];
        self.volumeBar.clipsToBounds = NO;
        self.volumeBar.layer.masksToBounds = NO;
...
- (void) updateControlForVolumeChange:(float)value {
    ...
    if (self.volumeControlStyle == ABVolumeControlStyleMinimal) {
        ...
        self.volumeBackground.frame = CGRectMake(0, 0, viewWidth, 4);

        CGRect volumeBarFrame = self.volumeBar.frame;

        CGFloat newWidth = value * viewWidth;
        volumeBarFrame.size = CGSizeMake(newWidth, 4);
        ...
        self.volumeBackground.frame = CGRectMake(12.0f, self.volumeBackground.frame.origin.y, viewWidth-24.0f, 4.0f);
        ...
        volumeBarFrame.size = CGSizeMake(newWidth, 4.0f);
